...
const AddCandidateModal = ({ open, setOpen, children }: ModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center  z-[1000] overflow-y-auto">
      <div
        ref={modalRef}
        className={`w-96 max-h-fit py-5 px-5 rounded-[4px] font-semibold flex flex-col justify-between items-center relative top-24 ${"bg-main-bg"}`}
      >
        <div
